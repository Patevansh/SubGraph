...
export class Uni__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Uni extends ethereum.SmartContract {
  ...
  checkpoints(param0: Address, param1: BigInt): Uni__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new Uni__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt,
  ): ethereum.CallResult<Uni__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Uni__checkpointsResult(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
